...
// .wrangler/tmp/bundle-SDa8vT/checked-fetch.js
...
// node_modules/.pnpm/wrangler@3.105.1_@cloudflare+workers-types@4.20250124.3/node_modules/wrangler/templates/modules-watch-stub.js
...
// .wrangler/tmp/bundle-SDa8vT/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-SDa8vT/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/index.ts
async function handleLocalTesting(request, env) {
...
__name(handleLocalTesting, "handleLocalTesting");
var src_default = {
  async fetch(request, env) {
    const bot = new Bot(env.BOT_TOKEN);
    if (true) {
      return handleLocalTesting(request, env);
    }
  ...
  async scheduled(event, env) {
    const bot = new Bot(env.BOT_TOKEN);
    const cronType = event.cron === "0 21 * * *" ? "daily" : "weekly";
    await setupPollSchedulers(bot, env, cronType);
  }
};

// node_modules/.pnpm/wrangler@3.105.1_@cloudflare+workers-types@4.20250124.3/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
init_checked_fetch();
init_modules_watch_stub();
...
// node_modules/.pnpm/wrangler@3.105.1_@cloudflare+workers-types@4.20250124.3/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
init_checked_fetch();
init_modules_watch_stub();
...
// node_modules/.pnpm/wrangler@3.105.1_@cloudflare+workers-types@4.20250124.3/node_modules/wrangler/templates/middleware/common.ts
init_checked_fetch();
init_modules_watch_stub();
